...
/**
 * Az MVC architektura Model reszet megvalosÌto osztalya.
 * @author Szabi
 * @version 1.0
...
public class RiskGameModel {
	...
	/**
	 * Csak akkor t·madhat, ha a terÅEeten elegend? egysÈge van.
	 * 
	 * @param attacker
	...
	/**
	 * Ez a fÅEgvÈny fogja a kockadob·sokkal tˆrtÈn? harcot szimul·lja.
	 * 
	 * @param attackerUnits
